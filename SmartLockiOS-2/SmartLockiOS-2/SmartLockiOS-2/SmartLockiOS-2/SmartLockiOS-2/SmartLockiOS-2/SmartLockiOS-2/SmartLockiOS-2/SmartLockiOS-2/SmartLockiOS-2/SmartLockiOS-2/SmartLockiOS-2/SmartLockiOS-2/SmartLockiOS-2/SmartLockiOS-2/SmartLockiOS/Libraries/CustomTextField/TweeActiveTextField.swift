...
open class TweeActiveTextField: TweeBorderedTextField {
	...
	private func observe() {
        ...
        notificationCenter.addObserver (self, selector: #selector(textFieldDidBeginEditing),name: UITextField.textDidBeginEditingNotification, object: Self.self)/*(self,
									   selector: #selector(textFieldDidBeginEditing),
                                       name: .UITextField.textDidBeginEditingNotification,
									   object: self)*/
        notificationCenter.addObserver (self, selector: #selector(textFieldDidEndEditing),name: UITextField.textDidEndEditingNotification, object: Self.self)
