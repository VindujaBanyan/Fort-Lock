...
//                        lockListObj.reference_no = result!["data"][i]["reference_no"].rawValue as! String
                        ...
                        lockListObj.enable_passage = result!["data"][i]["enable_passage"].rawValue as? String ?? "0"
...
//                    let success = locaDB.saveLock(lockobject: lock, passageModeSwitch: passageModeSwitch)
//                }
...
//                defaults.synchronize()
                ...
                if locaDB.fetchLockList() is [LockListModel] {
